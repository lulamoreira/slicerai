...
export const Wizard: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-full animate-in fade-in duration-500">
      ...
      {/* Footer */}
      <div className="fixed bottom-0 left-0 md:left-auto right-0 w-full md:w-[60%] px-6 md:px-12 py-4 bg-surface/95 backdrop-blur-md border-t border-border flex gap-4 z-30 shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
        {step > 1 && (
          <button
            onClick={prevStep}
